...
package com.liferay.contacts.service.configuration.configurator;

import com.liferay.contacts.upgrade.ContactsServiceUpgrade;
 ...
 * @author Joan Kim
 */
@Component(immediate = true, service = ContactsServiceConfigurator.class)
public class ContactsServiceConfigurator {
	...
	protected ClassLoader getClassLoader() {
		Class<? extends ContactsServiceConfigurator> clazz = getClass();
	...
	@Reference(unbind = "-")
	protected void setContactsServiceUpgrade(
		ContactsServiceUpgrade contactsServicesUpgrade) {
	}
